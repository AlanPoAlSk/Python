from login_and_registration_app.config.mysqlconnection import connectToMySQL
...
class Profile:
    ...
    def register(cls,form):
        ...
        query = """
            INSERT INTO profiles (first_name, last_name, email, password)
    ...
    def validate(form):
        ...
        query = 'SELECT * FROM profiles WHERE profiles.email = %(email)s'
        results= connectToMySQL('logins_registrations_schema').query_db(query,form)
        is_valid = True 
